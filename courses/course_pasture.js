    ...
    holes: [
        {
            ...
            description: "Welcome to The Pasture. The front gate is wide open, but the overgrown tractor paths mean you'll need to stay focused right out of the gate.",
        ...
        { par: 4, distance: 380, greenRadius: 14, pinX: -10, pinY: 380, greenType: "Back-to-Front", description: "A long, winding path historically used for heavy machinery. The ruts can kick your ball in unpredictable directions.", hazards: [{ type: "Bunker", distance: 200, depth: 15, offset: -15, width: 15 }, { type: "Bovine Herd" }], landingZones: [{ name: "Safe Drive", x: 0, y: 250 }, { name: "360y Target", x: -10, y: 360 }], zones: [{x:-10, y:220, w:40, h:40}], bgMusic: 'audio/courses/pasture/mu_pasture2.mp3', bgAmbient: 'audio/courses/pasture/am_cow1.mp3', loreName: "The Bovine Bounce" },
        { par: 5, distance: 485, greenRadius: 15, approachWidth: 15, pinX: 10, pinY: 485,
          greenType: "The False Front",
          description: "Home of the infamous 'Free Chicken' strategy. If you intentionally lay up near the coop, you might just earn yourself a free Gimme or Mulligan. But beware the twin bunkers guarding the green!",
          ...
          hazards: [
              ...
              { type: "Bunker", name: "Left Bunker", distance: 470, depth: 15, offset: -12, width: 12 },
              { type: "Bunker", name: "Right Bunker", distance: 470, depth: 15, offset: 12, width: 12 },
              { type: "Chicken Flock", distance: 220, offset: -15 }
          ],
        ...
        },
        {
            ...
            trees: [
                ...
                // Inner Dogleg Canopy
                { name: "Inner Dogleg Oak", x: 18, y: 210, radius: 10, height: 35 },
                { name: "Inner Dogleg Pine", x: 22, y: 225, radius: 10, height: 40 },
                { name: "Corner Guardian", x: 10, y: 240, radius: 12, height: 30 }
            ],
            hazards: [
                { type: "Tree Cluster", distance: 200, depth: 150, offset: 35, width: 80 },
                ...
                { type: "Tower Runoff", distance: 150, depth: 250, offset: -12, width: 20 },
